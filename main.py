...
# Chargement des images et du joueur
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
        elif event.type == OPEN_EVENT:
            open_event_active = True
            print("OPEN_EVENT déclenché!")
        elif event.type == CLOSE_EVENT:
            open_event_active = False
            print("CLOSE_EVENT déclenché!")
        elif event.type == pygame.KEYDOWN and open_event_active:
...
while entering_name:
    ...
    name_text = font.render("Enter your name sweaty :", True, (0,0,0))
